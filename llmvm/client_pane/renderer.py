...
class Renderer:
    def __init__(self, config):
        ...
        # Disable streaming when using Rich console as line clearing doesn't work properly
    ...
    def clear_line(self):
        """Clear current line"""
        # Disabled when using Rich console
        pass
    ...
    def _clear_streaming_lines(self):
        ...
        # Note: Clearing is disabled when using Rich console as it doesn't mix well
        # with Rich's own output management. The streamed content remains visible.
